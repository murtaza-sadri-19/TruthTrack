...
tfidf_vectorizer = load_model('Models/tfidf_vectorizer.pkl')  # Ensure correct path
nmf_model = load_model('Models/nmf_model.pkl')  # Ensure correct path
...
def prediction():
    if request.method == "POST":
        ...
        api_key = 'AIzaSyAJ35bRGdntEMaJTTkHeZ_YW3TGTeOyChI'  # Replace with your actual API key
        search_engine_id = 'b5df68cf05a6b4b20'  # Replace with your actual search engine ID
